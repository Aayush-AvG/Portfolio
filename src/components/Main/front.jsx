  ...
  return (
    ...
    >
      ...
      <div className="flex-1 relative z-20 p-4 sm:p-8 lg:p-16">
        ...
        <div className="absolute bottom-3 sm:bottom-40 lg:bottom-45 left-4 sm:left-8 lg:left-16 w-full sm:w-3/5 lg:w-2/5 invisible lg:visible mb-4 sm:mb-6 lg:mb-8 pr-4 sm:pr-8 lg:pr-0">
        ...
        <div className="absolute aver invisible rotate-0 lg:rotate-0 lg:top-145 md:rotate-90 md:-left-100 md:top-60 lg:visible md:visible bottom-20 sm:bottom-16 lg:bottom-20 sm:left-8 lg:left-8">
