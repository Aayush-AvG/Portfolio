  ...
  return (
    <div className="flex items-center justify-center relative">
      <div className="relative w-48 h-48 flex items-center justify-center group cursor-pointer">
        ...
        <div className="absolute inset-0 bg-gradient-radial from-slate-800/40 to-transparent rounded-full animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute inset-0 bg-gradient-radial from-transparent via-gray-600/15 to-grey-500/8 rounded-full animate-pulse" style={{ animationDuration: '6s', animationDelay: '2s' }} />
        ...
        <div className="absolute w-32 h-32 animate-spin" style={{ animationDuration: '12s' }}>
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="absolute w-3 h-3 bg-gradient-to-r from-grey-300 to-gray-400 rounded-full shadow-lg"
              style={{
                top: '50%',
                left: '50%',
        ...
        <div className="absolute w-24 h-24 bg-gradient-radial from-white/20 via-grey-500/30 to-gray-700/40 rounded-full animate-spin" style={{ animationDuration: '3s' }} />
        <div className="absolute w-22 h-22 bg-gradient-radial from-slate-200/40 via-gray-500/30 to-transparent rounded-full animate-spin" style={{ animationDuration: '4s', animationDirection: 'reverse' }} />

        {/* Main globe container - BIGGER */}
        <div className="relative z-10 w-20 h-20 bg-gradient-to-br from-grey-400 to-gray-600 rounded-full flex items-center justify-center shadow-2xl group-hover:shadow-grey-400/60 transition-all duration-700 group-hover:scale-125 border-2 border-white/30"
             style={{
        ...
        <div className="absolute w-32 h-32 border border-grey-400/30 rounded-full animate-ping" />
        <div className="absolute w-40 h-40 border border-gray-400/20 rounded-full animate-ping" style={{ animationDelay: '1s' }} />
